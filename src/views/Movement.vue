...
export default {
	...
	data() {
		return {
			...
			movementSpeed: 90,
            movementTargetPosition: 180,
            currentPosition: 0,
            movementStartPosition: 0,
            movementEndPosition: 180,
	...
	methods: {
        ...
        incrementRule(increment){
            ...
            if(parseFloat(this.movementEndPosition) % increment !== 0){
                return "La poscición final no es múltiplo del incremento"
            }else if(parseFloat(this.movementStartPosition) % increment !== 0){
                return "La posición inicial no el múltiplo del incremento"
        ...
        movementIncrementCorrect(){
            /* eslint-disable-next-line */
            if(!!this.incrementRule(this.movementIncrement)){
        ...
        async readPosition(){
            ...
            if (typeof pywebview !== "undefined") {
                /* eslint-disable-next-line */
                this.currentPosition = await pywebview.api.PyReadPos(this.axisSelected.number);
            }
        }    
